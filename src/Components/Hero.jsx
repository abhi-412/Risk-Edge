  ...
  return (
        <Suspense className='w-full h-full flex items-center justify-center' fallback={null}>
            ...
            <div className='absolute md:top-40 top-60 w-full  grid grid-cols-8 gap-4 place-items-center'>
                ...
                <button className='col-span-2 md:col-start-4 col-start-3 text-nowrap bg-cyan-600 hover:bg-transparent hover:border-4 hover:border-cyan-400 hover:scale-110 transition transform delay-75 hover:text-gray-200 text-lg px-8 py-2'>Learn More</button>
            </div>
        </Suspense>
  )
}
