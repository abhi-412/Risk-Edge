    ...
    return (
      <nav ref={navbarRef} className={`fixed top-0 left-0 w-full  z-10 bg-black`}>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" className="navlogo flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <div hidden={!openMenu} className="transition transform duration-300 w-full md:block md:w-auto" id="navbar-default">
            <ul className="navitems font-medium flex flex-col p-4 md:p-0 mt-4   rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 ">
              <li>
